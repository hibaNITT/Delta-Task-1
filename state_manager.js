...
function assignTeleportPair(board, pairId, firstRow, firstCol, secondRow, secondCol) {
...
export function createInitialState() {
  // Create an empty board: 12 rows by 6 columns
  const board = [];
  ...
  return {
    ...
    scores: { 1: 0, 2: 0 },  // Both players start with 0 score
    timeoutPenalties: { 1: 0, 2: 0 },  // No penalties yet
    gameOver: false,
